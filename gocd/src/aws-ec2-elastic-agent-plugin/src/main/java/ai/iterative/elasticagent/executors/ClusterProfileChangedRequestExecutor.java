...
import ai.iterative.elasticagent.ClusterProfileProperties;
import ai.iterative.elasticagent.requests.ClusterProfileChangedRequest;
import ai.iterative.elasticagent.AgentInstances;
import ai.iterative.elasticagent.AwsEC2AgentInstances;
...
public class ClusterProfileChangedRequestExecutor implements RequestExecutor {
    ...
    private void handleCreate(ClusterProfileChangedRequest request, Map<String, AgentInstances> allClusterInstances) {
        ...
        allClusterInstances.put(newlyCreatedCluster.uuid(), new AwsEC2AgentInstances());
    }
    ...
    private void handleUpdate(ClusterProfileChangedRequest request, Map<String, AgentInstances> allClusterInstances) {
        ...
        allClusterInstances.put(newCluster.uuid(), new AwsEC2AgentInstances());
    }
}
