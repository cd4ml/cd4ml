...
import ai.iterative.elasticagent.executors.*;
import ai.iterative.elasticagent.requests.*;
...
@Extension
public class AwsEC2Plugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(AwsEC2Plugin.class);
    ...
    public void initializeGoApplicationAccessor(GoApplicationAccessor accessor) {
        ...
        agentInstances = new AwsEC2AgentInstances();
