...
import ai.iterative.elasticagent.ClusterProfile;
...
import ai.iterative.elasticagent.requests.MigrateConfigPayload;
...
public class MigrateConfigRequestExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() throws Exception {
        ...
        return new DefaultGoPluginApiResponse(200, PluginSettings.GSON.toJson(payload));
    }
}
